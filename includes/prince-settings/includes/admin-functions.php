					...
					array(
						...
						'pages' => array(
							array(
								...
								'page_title'      => apply_filters( '__prefix_settings_page_title', __( 'Settings', 'notification-plus' ) ),
								'menu_title'      => apply_filters( '__prefix_settings_menu_title', __( 'Settings', 'notification-plus' ) ),
								...
								'updated_message' => apply_filters( '__prefix_settings_updated_message', __( 'Settings updated.', 'notification-plus' ) ),
								'reset_message'   => apply_filters( '__prefix_settings_reset_message', __( 'Settings reset.', 'notification-plus' ) ),
								'button_text'     => apply_filters( '__prefix_settings_button_text', __( 'Save Changes', 'notification-plus' ) ),
...
if ( ! function_exists( 'prince_admin_styles' ) ) {
	...
	function prince_admin_styles() {
		...
		/* load admin styles */
		wp_enqueue_style( 'prince-admin-css', __prefix_settings_assets_url . '/css/admin.css', false, false );
...
if ( ! function_exists( 'prince_admin_scripts' ) ) {
	...
	function prince_admin_scripts() {
		...
		//wp_enqueue_script( 'ace-editor', __prefix_settings_assets_url.'/ace.min.js', null, '1.1.3' );

		/* load all the required scripts */
		wp_enqueue_script( 'prince', __prefix_settings_assets_url . '/js/admin.js', array(
			'jquery',
			'jquery-ui-tabs',
			'jquery-ui-slider',
