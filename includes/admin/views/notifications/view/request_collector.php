...
<?php ob_start() ?>
<div class="altumcode-wrapper altumcode-wrapper-<?= $notification->settings->border_radius ?> altumcode-request-collector-wrapper" style="background: <?= $notification->settings->background_color ?>">
    <div class="altumcode-request-collector-content">
        <div class="altumcode-request-collector-header">
            <img src="<?= $notification->settings->image ?>" class="altumcode-request-collector-image" />
