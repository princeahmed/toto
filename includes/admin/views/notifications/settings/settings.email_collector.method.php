...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <label for="settings_email_placeholder"><?= $this->language->notification->settings->email_placeholder ?></label>
        <input type="text" id="settings_email_placeholder" name="email_placeholder" class="form-control" value="<?= $data->notification->settings->email_placeholder ?>" required="required" />
    </div>
