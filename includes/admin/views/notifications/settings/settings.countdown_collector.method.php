...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <label for="settings_end_date"><?= $this->language->notification->settings->end_date ?></label>
        <input type="text" id="settings_end_date" name="end_date" class="form-control" value="<?= $data->notification->settings->end_date ?>" autocomplete="off" required="required" />
    </div>
...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <label for="settings_time_color"><?= $this->language->notification->settings->time_color ?></label>
        <input type="hidden" id="settings_time_color" name="time_color" class="form-control" value="<?= $data->notification->settings->time_color ?>" required="required" />
        <div id="settings_time_color_pickr"></div>
    </div>

    <div class="form-group">
        <label for="settings_time_background_color"><?= $this->language->notification->settings->time_background_color ?></label>
        <input type="hidden" id="settings_time_background_color" name="time_background_color" class="form-control" value="<?= $data->notification->settings->time_background_color ?>" required="required" />
        <div id="settings_time_background_color_pickr"></div>
    </div>
...
<script>
    ...
    /* Time Color Handler */
    let settings_time_color_pickr = Pickr.create({
        el: '#settings_time_color_pickr',
        default: $('#settings_time_color').val(),
        ...pickr_options
    });

    settings_time_color_pickr.on('change', hsva => {
    ...
    let settings_time_background_color_pickr = Pickr.create({
        el: '#settings_time_background_color_pickr',
        default: $('#settings_time_background_color').val(),
        ...pickr_options
    });

    settings_time_background_color_pickr.on('change', hsva => {
