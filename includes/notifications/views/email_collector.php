...
<div class="notification-plus-wrapper notification-plus-email-collector-wrapper notification-plus-wrapper-<?php echo $notification->border_radius ?>" style="background: <?php echo $notification->background_color ?>">
